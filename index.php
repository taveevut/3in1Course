...
define( 'APP_FRONTEND', 'frontend' );

define( 'APP_API_PATH', 'app_api' );
define( 'APP_BACKEND_PATH', 'app_backend' );
define( 'APP_FRONTEND_PATH', 'app_frontend' );

if ( FALSE !== strpos( $_SERVER['HTTP_HOST'], 'shop-cms.test' ) ) {
    define( 'ENVIRONMENT', 'development' );
    define( 'SYSTEM_NAME', 'c-con' );
} else {
    define( 'ENVIRONMENT', 'development' );
    define( 'SYSTEM_NAME', 'c-con.ga' );
}
